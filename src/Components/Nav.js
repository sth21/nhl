...
export default function Nav() {
    ...
    return (
        <StyledNav>
            ...
            <StyledNavWrapper>
                <StyledLink to="https://shop.nhl.com/" target="_blank">Shop</StyledLink>
                <StyledLink to="https://ticketmaster.com/nhl" target="_blank">Tickets</StyledLink>
                <StyledLink to="https://plus.espn.com/nhl" target="_blank">Streaming</StyledLink>
