        ...
        <StyledScoreboardGameWrapper role="complementary" >
            ...
            <StyledScoreboardGameBody>
                <StyledScoreboardInfo>
                    ...
                    <p>{ (props.game.status.type.state === "pre") ? (gameInfo.competitors[0].records) ? gameInfo.competitors[0].records[0].summary : "0-0-0" : gameInfo.competitors[0].score }</p>
                </StyledScoreboardInfo>
                <StyledScoreboardInfo>
                    <StyledScoreboardTeam>
                    ...
                    <p>{ (props.game.status.type.state === "pre") ? (gameInfo.competitors[1].records) ? gameInfo.competitors[1].records[0].summary : "0-0-0" : gameInfo.competitors[1].score }</p>
                </StyledScoreboardInfo>
            </StyledScoreboardGameBody>
